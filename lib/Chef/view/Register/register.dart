...
class _RegisterChefState extends State<RegisterChef> {
  ...
  final chef_RegisterController _chef_registerController =
      chef_RegisterController();
                    ...
                    child: SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                            ...
                            label: CustomText1(text: 'Bio', size: 13),
                            border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(10))),
                      ),
                    ),
                      ...
                      child: ElevatedButton(
                          onPressed: () {
                            if (_formkey.currentState!.validate()) {
                              Chef_Register_Model chefregister =
                                  Chef_Register_Model(
                              ...
                              _chef_registerController.chefRegister(
                                  chefregister, context);
                              setState(() {
                          ...
                          child: CustomText1(text: 'Submit', size: 16)),
                    ),
                  ),
                  Padding(
                    padding: const EdgeInsets.only(top: 10),
