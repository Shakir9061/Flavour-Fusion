...
class Chefverify extends StatefulWidget {
  const Chefverify({super.key});

  @override
  State<Chefverify> createState() => _ChefverifyState();
}

class _ChefverifyState extends State<Chefverify> {
  @override
                ...
                child: Row(
                  ...
                  children: [
                    SizedBox(
                      ...
                      }, child: CustomText1(text: 'Reject', size: 19)),
                    ),
                     SizedBox(
                      width: 150,
                       child: ElevatedButton(
                        ...
                        onPressed: () {
                                         ...
                                         }, child: CustomText1(text: 'Accept', size: 19)),
                     ),
                  ],
                ),
              )
