...
class Shoppinglist_user extends StatefulWidget {
  const Shoppinglist_user({super.key});

  @override
  State<Shoppinglist_user> createState() => _Shoppinglist_userState();
}

class _Shoppinglist_userState extends State<Shoppinglist_user> {
