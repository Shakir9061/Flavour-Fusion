...
import 'package:flavour_fusion/User/view/Home/categoryuser.dart';
import 'package:flavour_fusion/User/view/Home/searchbyingredients.dart';
import 'package:flavour_fusion/User/view/Home/searchbytime.dart';
  ...
  Future<void> _showRecipesByCategory(String category) async {
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => CategoryRecipesPage_user(
            category: category,
            recipes: recipes,
          ),
        ),
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Searchbytimesuser()));
                      },
                      child: Card(
                        elevation: 10,
                        color: Theme.of(context).cardColor,
